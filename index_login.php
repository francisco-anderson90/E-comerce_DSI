                ...
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="box">
                        <form action="valida_login.php" method="POST">
                            <div class="field">
                                <div class="control">
                                    <input name="email" name="text" class="input is-large" type="email" placeholder="Seu e-mail" autofocus="">
                                </div>
                            </div>
                        ...
                        <form action="cadcliente.php" method="POST">
                            <button type="submit" class="button is-block is-link is-large is-fullwidth">Cadastre-se Aqui</button>
                        </form><br>
                        <form action="login_func.php" method="POST">
                            <button type="submit" class="button is-block is-link is-large is-fullwidth">Apenas para administradores</button>
                        </form>
                    </div>
                </div>
            </div>
